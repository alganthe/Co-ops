...
[_markerPos,[true], [true], [true], [true], [true], [true], true] remoteExecCall ["derp_fnc_mainAOSpawnHandler", derp_HCAOs];
    _mainAOUnits = spawnedUnits;
spawnedUnits = nil;

} else {
    _mainAOUnits = [_markerPos,[true], [true], [true], [true], [true], [true], true] call derp_fnc_mainAOSpawnHandler;
};
