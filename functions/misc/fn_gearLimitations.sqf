...
_marksmenRestricted = [{_unit getUnitTrait 'derp_marksman'}, [
    //optics
...
_machinegunRestricted = [{_unit getUnitTrait 'derp_machinegunner'}, [
...
_uavOperatorRestricted = [{_unit getUnitTrait 'derp_uavOperator'}, ["B_UavTerminal"], "UAV operator"];

_grenadierRestricted = [{_unit getUnitTrait 'derp_grenadier'}, [
