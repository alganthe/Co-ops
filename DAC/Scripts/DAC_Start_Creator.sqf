...
if(DAC_Fast_Init) then {if((isServer || isHC) && (local player)) then {_vD = ViewDistance;_fg = fog;0 setFog 1;setViewDistance 5}};
...
if(DAC_Fast_Init) then {if((isServer || isHC) && (local player)) then {setViewDistance _vD;0.5 setFog _fg}};