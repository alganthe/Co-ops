...
// REDFOR (A3)
  case 0:
  {
    _Unit_Pool_S = ["O_helipilot_F","O_soldier_repair_F","O_soldier_exp_F","O_Soldier_F","O_Soldier_lite_F","O_Soldier_LAT_F","O_Soldier_GL_F","O_soldier_M_F","O_medic_F","O_Soldier_SL_F"];
    _Unit_Pool_V = ["O_MRAP_02_F","O_MRAP_02_hmg_F","O_MRAP_02_gmg_F"];
    _Unit_Pool_T = ["O_APC_Tracked_02_cannon_F","O_APC_Tracked_02_AA_F","O_MBT_02_cannon_F"];
	_Unit_Pool_A = ["O_Heli_Light_02_F","O_Heli_Attack_02_F","O_Plane_CAS_02_F","O_Heli_Transport_04_F","O_Heli_Transport_04_bench_F"];
  };
//-------------------------------------------------------------------------------------------------
// BLUFOR (A3)
  case 1:
